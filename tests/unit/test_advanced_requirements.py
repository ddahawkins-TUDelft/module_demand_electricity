...
def test_compile_auxiliary_requirements_collects_sources() -> None:
    overrides = {
        "reconstruct_albania": {
            ...
            "sources": [
                {"country": "GRC", "start": "2019-01-01", "end": "2019-01-03"},
                {
                    "country": "MNE",
                    "start": "2020-01-01",
                    "end": "2020-01-03",
    ...
    expected = pd.DataFrame(
        {
            "country": ["GRC", "MNE"],
            "start": pd.to_datetime(["2019-01-01", "2020-01-01"], utc=True),
            "end": pd.to_datetime(["2019-01-03", "2020-01-03"], utc=True),
        }
    )
...
def test_compile_auxiliary_requirements_includes_scaling_sources() -> None:
    overrides = {
        "reconstruct_albania": {
            ...
            "scope": "fill_gaps",
            "method": "construct_from_sources",
            "sources": [{"country": "GRC", "start": "2019-01-01", "end": "2019-01-03"}],
            "scaling": {
                "method": "match_energy",
                "target_sources": [
                    {"country": "ALB", "start": "2020-01-01", "end": "2020-01-03"}
                ],
            },
        }
    }
    ...
    assert list(result["country"]) == ["ALB", "GRC"]

    assert result.loc[result["country"] == "ALB", "start"].iloc[0] == pd.Timestamp(
        "2020-01-01", tz="UTC"
    )


def test_compile_auxiliary_requirements_deduplicates_sources() -> None:
    source = {"country": "GRC", "start": "2019-01-01", "end": "2019-01-03"}

    overrides = {
        "first_rule": {"method": "construct_from_sources", "sources": [source]},
        "second_rule": {"method": "construct_from_sources", "sources": [source]},
    }
...
def test_compile_auxiliary_requirements_ignores_other_methods() -> None:
    overrides = {
        "manual_case": {"method": "leave_missing"},
        "leave_case": {"method": "leave_missing"},
    }
...
def test_compile_auxiliary_requirements_merges_overlapping_periods() -> None:
    overrides = {
        "first_rule": {
            "method": "construct_from_sources",
            "sources": [{"country": "GRC", "start": "2019-01-01", "end": "2019-06-01"}],
        },
        "second_rule": {
            "method": "construct_from_sources",
            "sources": [{"country": "GRC", "start": "2019-05-01", "end": "2019-12-01"}],
        },
    }
    ...
    assert len(result) == 1
    assert result.iloc[0]["start"] == pd.Timestamp("2019-01-01", tz="UTC")
    assert result.iloc[0]["end"] == pd.Timestamp("2019-12-01", tz="UTC")
...
def test_compile_auxiliary_requirements_merges_adjacent_periods() -> None:
    overrides = {
        "first_rule": {
            "method": "construct_from_sources",
            "sources": [{"country": "GRC", "start": "2019-01-01", "end": "2019-02-01"}],
        },
        "second_rule": {
            "method": "construct_from_sources",
            "sources": [{"country": "GRC", "start": "2019-02-01", "end": "2019-03-01"}],
        },
    }
    ...
    assert len(result) == 1
    assert result.iloc[0]["start"] == pd.Timestamp("2019-01-01", tz="UTC")
    assert result.iloc[0]["end"] == pd.Timestamp("2019-03-01", tz="UTC")
...
def test_expand_requirements_without_rules_is_unchanged() -> None:
    ...
    result = expand_auxiliary_requirements(requirements, rules=[])
...
def test_build_auxiliary_acquisition_requirements_uses_basic_cleaning_config() -> None:
    overrides = {
        "reconstruct_albania": {
            "method": "construct_from_sources",
            "sources": [{"country": "GRC", "start": "2020-01-01", "end": "2020-02-01"}],
        }
    }
    ...
    result = build_auxiliary_acquisition_requirements(
        overrides=overrides, basic_rules=basic_rules, basic_cleaning_enabled=True
    )

    assert result.iloc[0]["start"] == pd.Timestamp("2019-12-25", tz="UTC")
    assert result.iloc[0]["end"] == pd.Timestamp("2020-02-08", tz="UTC")
